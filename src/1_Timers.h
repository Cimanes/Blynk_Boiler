...
//  Timer intervals
// --------------------------------------------
static constexpr unsigned long Dt_clock  = 5000UL ; // time interval (ms) for blynk-clock refresh during boot (5000).
static constexpr unsigned long Dt_LED    =  500UL ; // LED on timer (ms) to show that it has changed mode.
